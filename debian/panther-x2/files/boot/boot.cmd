...
#
# Please edit /boot/debianEnv.txt to set supported parameters
#
...
if test -e ${devtype} ${devnum} ${prefix}debianEnv.txt; then
	load ${devtype} ${devnum} ${load_addr} ${prefix}debianEnv.txt
